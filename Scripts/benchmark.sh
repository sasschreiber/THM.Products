...
printf "\n\n########### Flat Hierarchy Test ###########\n\n" >> $LOGFILE
./flow benchmark:write --productsCount 500 --propertiesPerProduct 0 --childrenDepth 0 --childrenLength 0 >> $LOGFILE
printf "\n\n" >> $LOGFILE
...
printf "\n\n########### Referencing Test ###########\n\n" >> $LOGFILE
./flow benchmark:write --productsCount 100 --propertiesPerProduct 0 --childrenDepth 4 --childrenLength 1 >> $LOGFILE
printf "\n\n" >> $LOGFILE
